...
import { useAPIs, useMemoX, useModifyData, useThemeX } from 'hooks'
...
const VideosTabController = () => {
    ...
    const SCR_HEIGHT = useMemoX(() => _HEIGHT - (BOTTOM_TAB_HEIGHT + top + bottom), [_HEIGHT, BOTTOM_TAB_HEIGHT, top, bottom]);
