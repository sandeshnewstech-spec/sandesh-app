...
import { CategoryItemsListingScreen, InterestScreen, LanguageSelectionScreen, LiveTVScreen, LocationScreen, WebStoriesListScreen, WebStoryViewScreen } from 'screens';
    ...
    return (
        <Fragment>
            {isAppStartFlow ? (<AppStack.Navigator screenOptions={{ animation: 'slide_from_right', headerShown: false, }} >
                ...
                : (<AppStack.Navigator screenOptions={{ headerShown: false }} initialRouteName='BottomTab' >
